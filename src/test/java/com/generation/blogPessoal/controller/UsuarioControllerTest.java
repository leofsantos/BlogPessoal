...
@SpringBootTest(webEnvironment = WebEnvironment.RANDOM_PORT) //___RODA A APLICAÇÃO EM MEMÓRIA SOMENTE PRA TESTE. SE ACHAR A PORTA SENDO USADA, CRIA OUTRA AUTOMATICAMENTE
@TestInstance(TestInstance.Lifecycle.PER_CLASS) //__APENAS DIZ QUE É UMA CLASSE DE TESTE
@TestMethodOrder(MethodOrderer.OrderAnnotation.class)//____ORDENA OS TESTES
